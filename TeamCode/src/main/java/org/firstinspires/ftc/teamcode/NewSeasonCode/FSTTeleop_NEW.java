...
@Config
@TeleOp(name = "FST TeleOp [NEW]")
public class FSTTeleop_NEW extends LinearOpMode {
    ...
    final int FRONT_SLIDE_PASSTHROUGH = 1400;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        pitchArm = new QuadServoPitch(this);
...
//            pitchArm.setPower(pitchPower);
            pitchArm.setTarget((int) pitchFrontTarget);
            pitchArm.periodic();
...
//                    telemetry.addData("Sliding Up", power2);
                ...
                case SLIDEDOWN: {
                    ...
                    if (Math.abs(pitchArm.getPosition() - pitchFrontTarget) > 10) {
                        slideFrontTarget = FRONT_SLIDE_PASSTHROUGH;
                    } else {
                        slideFrontTarget = 0;
                    }
