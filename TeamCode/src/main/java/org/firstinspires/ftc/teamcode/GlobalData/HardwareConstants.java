...
public class HardwareConstants {
    ...
    public final static double PITCH_ZERO = 0.79, PITCH_PICKUP = 0.03, PITCH_HOVER = 0.09, PITCH_REVERSE = 0.06 , PITCH_CAMERA = 0.3, PITCH_PASSTHROUGH = 0.94, PITCH_SCORING = .79;
    ...
    public final static double BACK_CLAW_OPEN = 0.78, BACK_CLAW_SLIGHT_CLOSE = 0.22, BACK_CLAW_CLOSE_FULL = 0.2;
