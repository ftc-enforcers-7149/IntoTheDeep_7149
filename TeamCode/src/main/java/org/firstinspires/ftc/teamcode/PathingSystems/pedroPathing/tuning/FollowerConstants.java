package org.firstinspires.ftc.teamcode.PathingSystems.pedroPathing.tuning;
...
import org.firstinspires.ftc.teamcode.PathingSystems.pedroPathing.util.CustomFilteredPIDFCoefficients;
import org.firstinspires.ftc.teamcode.PathingSystems.pedroPathing.util.CustomPIDFCoefficients;
import org.firstinspires.ftc.teamcode.PathingSystems.pedroPathing.util.KalmanFilterParameters;
...
public class FollowerConstants {
    ...
    private static double xMovement = 69.9488;
    private static double yMovement = 50.9436;
    ...
    public static double translationalPIDFFeedForward = 0.022;
    ...
    public static double headingPIDFFeedForward = 0.025;
    ...
    public static double mass = 15.34503;

    // Centripetal force to power scaling
    public static double centripetalScaling = 0.00037;


    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double forwardZeroPowerAcceleration = -27.7602;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -71.11617;
    ...
    public static double pathEndVelocityConstraint = 3;  //previously 0.1
    ...
    // This can be custom set for each Path.
    public static double pathEndHeadingConstraint = 0.01;  //previously 0.007

    // When the t-value of the closest point to the robot on the Path is greater than this value,
    // then the Path is considered at its end.
    // This can be custom set for each Path.
    public static double pathEndTValueConstraint = 0.95;   //changed from 0.995

    // When the Path is considered at its end parametrically, then the Follower has this many
    // milliseconds to further correct by default.
    // This can be custom set for each Path.
    public static double pathEndTimeoutConstraint = 150;  //previously 500
    ...
    public static double secondaryHeadingPIDFFeedForward = 0.09;
