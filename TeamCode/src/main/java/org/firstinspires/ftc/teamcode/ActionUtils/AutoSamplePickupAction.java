...
public class AutoSamplePickupAction extends EventAction {
    ...
    private EventAction pickupAction, autoAction, totalAction;
    ...
    public AutoSamplePickupAction(LLSampleVision vision, OuttakeExtendo ext, ClawDifferential diffy, Follower follow, EventAction pickup) {
        pickupAction = pickup;
        visionSystem = vision;
        extendo = ext;
        diffyClaw = diffy;
    ...
    public boolean run(CombinedTelemetry t) {
        ...
        if (!positionReceived) {
            ...
            totalAction = new SequentialAction(autoAction, pickupAction);
