...
import org.firstinspires.ftc.teamcode.PathingSystems.pedroPathing.localization.GoBildaPinpointDriver;
...
public class TwoWheelPinpointIMULocalizer extends Localizer {
    ...
    public TwoWheelPinpointIMULocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(-0.1, 7.56, 0);
        strafeEncoderPose = new Pose(-0.15, 0.1, Math.toRadians(90));
        ...
        forwardEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "leftFront"));
