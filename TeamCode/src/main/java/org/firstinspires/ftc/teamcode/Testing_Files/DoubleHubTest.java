...
public class DoubleHubTest  extends LinearOpMode {
    ...
    DcMotorEx m1, m2, m3, m4, motor2;
    Servo s1, s2, s3, s4, s5, s6, servo2;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        t2 = hardwareMap.get(RevTouchSensor.class, "t1");
        t3 = hardwareMap.get(RevTouchSensor.class, "t1");
        t4 = hardwareMap.get(RevTouchSensor.class, "t1");
        ...
        touchSensor2 = hardwareMap.get(RevTouchSensor.class, "touchSensor2");
        colorSensor2 = hardwareMap.get(NormalizedColorSensor.class, "colorSensor2");
        potentiometer2 = hardwareMap.get(AnalogInput.class, "potentiometer2");

        HubTest.CameraStreamProc processor = new HubTest.CameraStreamProc();
        ...
        while (opModeIsActive() && !isStopRequested()){
            ...
            telemetry.addData("Motor Positions",motor2.getCurrentPosition());
            servo2.setPosition(gamepad1.left_trigger);
            telemetry.addData("Servo Position", servo2.getPosition());

            boolean state = touchSensor2.isPressed();
            telemetry.addData("Touch sensor", state);

            double volt = potentiometer2.getVoltage();
            telemetry.addData("Potentiometer", volt);
            ...
            if (colorSensor2 instanceof DistanceSensor){
                double distance = ((DistanceSensor) colorSensor2).getDistance(DistanceUnit.MM);
