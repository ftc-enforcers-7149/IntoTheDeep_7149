...
//    final int SAMPLE_ABOVE_PITCH_POS = 975, SAMPLE_PICKUP_PITCH_POS = 1050;
    ...
    final int SAMPLE_ABOVE_PITCH_POS = 910, SAMPLE_PICKUP_PITCH_POS = 1005, SAMPLE_OUT_PITCH_POS = 970;
//new with camera
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive() && !isStopRequested()) {
            ...
            wristFront.setPosition(frontWristPos);
                ...
                case INTAKING: {
                    ...
                    switch (inStageFront) {
                        ...
                        case ABOVE: {
                            ...
                            if (changeWrist) {
                                frontWristPos = Range.clip(frontWristPos + (frontWristSpeed * gamepad2.right_stick_x), 0, 1);
                            }
