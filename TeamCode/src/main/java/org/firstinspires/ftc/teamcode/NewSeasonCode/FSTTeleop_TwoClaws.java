...
//    final int SAMPLE_ABOVE_PITCH_POS = 910, SAMPLE_PICKUP_PITCH_POS = 1020;
    ...
    final double BACK_PITCH_IDLE = 0.0, BACK_PITCH_ABOVE = 0.36, BACK_PITCH_PICKUP = 0.4, BACK_PITCH_WALL = 0.1554, BACK_PITCH_CHAMBER = 0.1554;
//NEW ANGLES 30 degrees = .1333, 35 degrees = .1554, 40 degrees = .1778, 45 degrees = .2
// 1 degree = .00444444444444
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //good
        slideController2 = new PIDFController(0.03, 0, 0.0004, 0.0);
        //good
...
//                    telemetry.addData("Sliding Up", power2);
                ...
                case OUTTAKING: {
                    ...
                    if (gamepad2.right_bumper && slideFrontTarget == 1500) { //TODO TOP ONE SHOULD BE DOUBLE BOTTOM
...
//                        slideBackTarget = 1800;
                    ...
                    if (gamepad2.cross) {
                        ...
                        pitchBackTarget = (int) (SAMPLE_ABOVE_PITCH_POS) + 20;
                        pitchBackpos = .36;
...
//                    }
                ...
                case SLIDEDOWN: {
                    ...
                    if (slidesBack.slideMotor.getCurrentPosition() < 200) {
                        pitchBackTarget = 0;
                        pitchBackpos = BACK_PITCH_IDLE;
                    }
                    ...
                    if (Math.abs(slidesBack.slideMotor.getCurrentPosition() - slideBackTarget) < 30) { //changed
                        stageBack = Stages.IDLE;
                    } //changed
...
//                            slideBackTarget = SAMPLE_ABOVE_SLIDE_POS; changed
                            ...
                            if (gamepad2.cross && !(prevGamepad2.cross)) {
                                ...
                                pitchBackTarget = (int) (SAMPLE_PICKUP_PITCH_POS) + 60;
...
//                                slideBackTarget = 950; changed
                        ...
                        case SPECIMEN_PICKUP: {
                            ...
                            if (gamepad2.circle) {
                                ...
                                slideBackTarget = 120; //TODO PULLING OFF THE WALL, EVEN LOWER
                ...
                case PITCHUP: {
                    ...
                    switch(inStageBack) {
                        ...
                        case SPECIMEN_ABOVE: {
                            pitchBackTarget = (int) (SPECIMEN_ABOVE_PITCH_POS);
                            pitchBackpos = 0.15;
                            break;
                        }

                        case ABOVE: {
                            pitchBackTarget = (int) (SAMPLE_ABOVE_PITCH_POS);
                            pitchBackpos = BACK_PITCH_ABOVE;
                            break;
                        }
                    }
